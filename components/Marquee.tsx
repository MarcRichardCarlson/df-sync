...
const MarqueeScroll: React.FC = () => {
  return (
    ...
    <div className='bg-CustomWhite w-full h-full overflow-hidden'>
      <Marquee speed={80}>
        <div className="flex whitespace-nowrap space-x-16">
            <Image src={image1} alt="energy logo" style={{objectFit: 'cover', marginLeft: '4rem'}}/>
            <Image src={image2} alt="crypto-now logo" style={{objectFit: 'cover'}}/>
            <Image src={image3} alt="gb-glass logo" style={{objectFit: 'cover'}}/>
            <Image src={image4} alt="mcd logo" style={{objectFit: 'cover'}}/>
            <Image src={image5} alt="mtg logo" style={{objectFit: 'cover'}}/>
            <Image src={image6} alt="object-vision logo" style={{objectFit: 'cover'}}/>
            <Image src={image7} alt="qx logo" style={{objectFit: 'cover'}}/>
            <Image src={image8} alt="skanska logo" style={{objectFit: 'cover'}}/>
            <Image src={image9} alt="smile logo" style={{objectFit: 'cover'}}/>
            <Image src={image10} alt="srv logo" style={{objectFit: 'cover'}}/>
            <Image src={image11} alt="svalner logo" style={{objectFit: 'cover'}}/>
            <Image src={image12} alt="verifone logo" style={{objectFit: 'cover'}}/>
