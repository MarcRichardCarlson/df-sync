      ...
      <div className="flex justify-between items-center w-full pl-2 px-4 py-2 border border-indigo-500 rounded-md">
        <div className='flex gap-4 items-center'>
          <button
            ...
            className="cursor-pointer px-4 py-2 border border-transparent hover:bg-CustomWhite hover:bg-opacity-20 rounded-md bg-CustomWhite bg-opacity-10 hover:border hover:border-indigo-500"
          >
        ...
        {fileName ? (
          <Image
            ...
            className="cursor-pointer w-6 h-6 rounded-md"
            src={CloseIcon}
            alt="Remove Icon"
